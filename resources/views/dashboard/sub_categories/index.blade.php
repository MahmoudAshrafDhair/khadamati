    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('sub_category.title')}}
        ...
        <div class="card-body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="data-table">
                ...
                <tr>
                    ...
                    <th>{{__('sub_category.category')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{__('sub_category.delete')}}</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.delete').click(function (e) {
                ...
                var url = '{{route('admin.sub.categories.destroy')}}';
                var type = "post";
                $.ajax({
                    type: type,
                    url: url,
