...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.sub.categories.create')}}" class="text-muted">{{__('sub_category.add')}}</a>
    </li>
@stop
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">{{__('sub_category.add')}}</h3>
                </div>
                <!--begin::Form-->
                <form class="form" method="post" action="{{route('admin.sub.categories.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
