    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('contacts.title_worker')}}
{{--                    <span class="text-muted pt-2 font-size-sm d-block">Javascript array as data source</span></h3>--}}
            </div>
{{--            <div class="card-toolbar">--}}
{{--                <!--begin::Button-->--}}
{{--                <a href="{{route('admin.sub.categories.create')}}" class="btn btn-info font-weight-bolder">--}}
{{--											<span class="svg-icon svg-icon-md">--}}
{{--												<i class="fa fa-plus"></i>--}}
{{--											</span>{{__('sub_category.add')}}</a>--}}
{{--                <!--end::Button-->--}}
{{--            </div>--}}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{__('contacts.delete')}}</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.delete').click(function (e) {
                ...
                var url = '{{route('admin.contact.destroy.worker')}}';
                var type = "post";
                $.ajax({
                    type: type,
                    url: url,
            ...
            $(function () {
                $('#data-table').DataTable({
                    ...
                    @endif
                    ajax: {
                        url: '{{ route('admin.contact.index.worker') }}',
                        // data: function (d) {
                        //     d.type = $("#type").val();
                        //     d.search = $("#search").val();
                        // }
