...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.workers.create')}}" class="text-muted">{{__('worker.add')}}</a>
    </li>
@stop
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">{{__('worker.add')}}</h3>
                </div>
                <!--begin::Form-->
                <form class="form" method="post" action="{{route('admin.workers.store')}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
...
{{--                                        <input type="hidden" name="profile_avatar_remove"/>--}}
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="username"
                                       placeholder="{{__('worker.username')}}" value="{{old('username')}}"/>
                                @error('username')
                                <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="email" class="form-control" name="email"
                                       placeholder="{{__('worker.email')}}" value="{{old('email')}}"/>
                                @error('email')
                                <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="form-control" name="phone"
                                       placeholder="{{__('worker.phone')}}" value="{{old('phone')}}"/>
                                @error('phone')
                                <span class="form-text text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <select class="form-control" id="kt_select2_1" name="subCategory_id" data-lang="{{ LaravelLocalization::getCurrentLocale() }}">
