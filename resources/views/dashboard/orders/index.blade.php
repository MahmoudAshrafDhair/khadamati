    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-6 pb-0">
            <div class="card-title">
                <h3 class="card-label">{{__('order.title')}}
        ...
        <div class="card-body">
            ...
            <table class="table table-striped- table-bordered table-hover table-checkable" id="data-table">
                ...
                <tr>
                    <th>#</th>
                    <th>{{__('order.user')}}</th>
                    <th>{{__('order.worker')}}</th>
                    <th>{{__('order.subCategory')}}</th>
                    <th>{{__('order.states')}}</th>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">{{__('order.delete')}}</h5>
