...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">
        <a href="{{route('admin.create')}}" class="text-muted">{{__('admin.admin_add')}}</a>
    </li>
@stop
        ...
        <div class="col-lg-12">
            ...
            <div class="card card-custom">
                <div class="card-header">
                    <h3 class="card-title">{{__('admin.admin_add')}}</h3>
                </div>
                <!--begin::Form-->
                            ...
                            <div class="col-lg-6">
                                <div class="image-input image-input-outline image-input-circle" id="kt_image_3">
                                    <div class="image-input-wrapper"
                                         style="background-image: url({{asset('assets/media/users/100_3.jpg')}})"></div>
                                    <label
